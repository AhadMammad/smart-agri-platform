"""Field imagery — Bronze and Silver.

Extracts the satellite and drone vegetation indices into the lake and conforms them.
...
with DAG(
    dag_id="imagery_daily",
    description="Field imagery: Postgres to the Bronze and Silver lake zones",
    schedule="@daily",
    ...
    tags=["imagery", "lake", "phase-5"],
    doc_md=__doc__,
) as dag:
    build_domain_stages("imagery")
